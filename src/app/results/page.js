...
const page = () => {
  ...
  // TODO: make summary a state variable
  ...
  const fetchImage = async () => {
    try {
      const response = await axios.post(
        ...
        {
          prompt: "girl running in the forest, manga",
